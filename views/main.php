            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h2 class="text-primary font-weight-medium m-0">Hemos Servido</h2>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <h2 class="text-primary font-weight-medium m-0">Es un placer servirles</h2>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 py-0 py-lg-5">
                    ...
                    <h5 class="mb-3">Desde primeras horas de la mañana nuestra cocina abierta desprende los olores de una comida fresca y generosa.</h5>
                    <p>En un ambiente cálido y desentendido brindamos desayunos, almuerzos y café con una atención cariñosa y cercana.</p>
                ...
                <div class="col-lg-4 py-0 py-lg-5">
                    <h1 class="mb-3">Lo hecho en casa es mejor</h1>
