...
<body>
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="section-title">
                <h4 class="text-primary text-uppercase" style="letter-spacing: 5px;">Editar promociones</h4>
                <h1 class="display-4">Lista de promociones</h1>
            </div>

         <!-- Botón para agregar una nueva promocion -->
        <div class="mb-3">
                <a href="insertar_Promocion.php" class="btn btn-success">Agregar Promocion</a>
            </div>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th>Fecha de inicio de la promocion</th>
                        <th>Fecha limite de la promocion</th>
                        <th>Acción</th>     
                    </tr>
                </thead>
                <tbody>
                        ...
                        <?php foreach ($promociones as $promocion): ?>
                            <tr>
                                <td>
                                    ...
                                    <img class="w-100 rounded-circle" src="/Administracion-Cafeteria/img/promocion.png" alt="Imagen de la promocion" style="width: 100px; height: 100px;">                                    
                                </td>
                                <td><?= htmlspecialchars($promocion['NOMBRE_PROMOCION'], ENT_QUOTES, 'UTF-8') ?></td>
                                <td><?= htmlspecialchars($promocion['FECHA_INICIO'], ENT_QUOTES, 'UTF-8') ?></td>
                                <td><?= htmlspecialchars($promocion['FECHA_FIN'], ENT_QUOTES, 'UTF-8') ?></td>
                                
                                <td>
                                    <!-- Botones de acción -->
                                    <a href="actualizarPromocion.php?id=<?= $promocion['ID_PROMOCION'] ?>" class="btn btn-warning btn-sm">Actualizar</a>         
                                    <a href="eliminar_promocion.php?id=<?= $promocion['ID_PROMOCION'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Seguro que deseas eliminar este cliente?');">Eliminar</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr>
                        <td colspan="5" class="text-center">No se encontraron registros de promociones. Por favor, agrega nuevas promociones.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
